...
const MainApp: React.FC = () => {
  ...
  const handleGenerate = async () => {
    // Note: If apiKey is empty, geminiService will use the Cloud Proxy (Free Trial)
    setIsGenerating(true);
    const payload = getPayload();
    // Pass empty string if undefined to match expected type, service handles the logic
